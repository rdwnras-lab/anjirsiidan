...
supabaseAdmin.from(‘products’).select(`*, categories(name, icon, slug), product_variants(id, price), product_keys(id, is_used)`).eq(‘is_active’, true).order(‘sort_order’).limit(50),
